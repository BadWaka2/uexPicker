...
import org.zywx.wbpalmstar.plugin.uexpicker.ImageColorUtils;
...
public class WheelView extends View {
	...
	private int VALUE_TEXT_COLOR = ImageColorUtils.parseColor("#023BA1");
	...
	public int ADDITIONAL_ITEM_HEIGHT = 40;
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(EUExUtil.getResDrawableID("plugin_uexpicker_wheel_val"));
		}
		...
		// setBackgroundResource(R.drawable.plugin_uexpicker_wheel_bg);
	}
